...
module processor_system (
  ...
  wire timer_irq_req, timer_irq_ret;
  ...
  (
    ...
    .irq_req_o      ( timer_irq_req  ),
    .irq_ret_i      ( timer_irq_ret  )
  );
